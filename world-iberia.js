...
const CIDADES = [
  { id:'lisboa',    nome:'Lisboa',      x:  349.1, y:  692.5, lado:'O', papel:'capital', tamanho:'capital',  sprite:'castelo',       dono:'oeste', par:'barcelona', custoLisboa:  0.0, custoBarcelona: 18.0, desloc:[-21.4,6.7] },
  { id:'santarem',  nome:'Santarem',    x:  362.1, y:  591.5, lado:'O', papel:'anel1a',  tamanho:'pequena',  sprite:'aldeia_neutra', dono:null,    par:'tarragona', custoLisboa:  1.0, custoBarcelona: 17.0, desloc:[-6.0,8.0] },
  { id:'evora',     nome:'Evora',       x:  426.6, y:  679.4, lado:'O', papel:'anel1b',  tamanho:'pequena',  sprite:'aldeia_neutra', dono:null,    par:'girona',    custoLisboa:  1.5, custoBarcelona: 19.5, desloc:[4.7,9.3] },
  { id:'coimbra',   nome:'Coimbra',     x:  453.2, y:  525.4, lado:'O', papel:'anel2a',  tamanho:'pequena',  sprite:'aldeia_neutra', dono:null,    par:'castellon', custoLisboa:  2.5, custoBarcelona: 16.5, desloc:[2.7,16.0] },
  { id:'porto',     nome:'Porto',       x:  417.8, y:  434.5, lado:'O', papel:'anel3a',  tamanho:'grande',   sprite:'aldeia_neutra', dono:null,    par:'valencia',  custoLisboa:  3.5, custoBarcelona: 16.5, desloc:[0.0,10.0] },
  ...
  { id:'faro',      nome:'Faro',        x:  377.4, y:  814.0, lado:'O', papel:'anel2c',  tamanho:'pequena',  sprite:'aldeia_neutra', dono:null,    par:'huesca',    custoLisboa:  5.0, custoBarcelona: 16.0, desloc:[2.0,12.7] },
  { id:'vigo',      nome:'Vigo',        x:  470.7, y:  294.5, lado:'O', papel:'anel4a',  tamanho:'pequena',  sprite:'aldeia_neutra', dono:null,    par:'murcia',    custoLisboa:  5.0, custoBarcelona: 15.0, desloc:[2.0,8.0] },
  { id:'salamanca', nome:'Salamanca',   x:  666.9, y:  474.5, lado:'O', papel:'anel3c',  tamanho:'media',    sprite:'aldeia_neutra', dono:null,    par:'teruel',    custoLisboa:  6.5, custoBarcelona: 12.5, desloc:[2.7,11.3] },
  { id:'sevilha',   nome:'Sevilha',     x:  583.6, y:  804.5, lado:'O', papel:'anel3b',  tamanho:'pequena',  sprite:'aldeia_neutra', dono:null,    par:'pamplona',  custoLisboa:  7.0, custoBarcelona: 14.5, desloc:[0.8,10.9] },
  { id:'cordoba',   nome:'Cordoba',     x:  806.4, y:  830.1, lado:'O', papel:'anel4b',  tamanho:'media',    sprite:'aldeia_neutra', dono:null,    par:'burgos',    custoLisboa:  8.0, custoBarcelona: 12.0, desloc:[-0.7,16.0] },
  { id:'toledo',    nome:'Toledo',      x:  734.3, y:  632.2, lado:'O', papel:'centro',  tamanho:'grande',   sprite:'aldeia_neutra', dono:null,    par:'madrid',    custoLisboa:  8.5, custoBarcelona:  9.5, desloc:[2.0,10.0] },
  { id:'barcelona', nome:'Barcelona',   x: 1401.8, y:  488.0, lado:'E', papel:'capital', tamanho:'capital',  sprite:'castelo',       dono:'este',  par:'lisboa',    custoLisboa: 18.0, custoBarcelona:  0.0, desloc:[-13.1,0.0] },
  { id:'tarragona', nome:'Tarragona',   x: 1295.6, y:  490.6, lado:'E', papel:'anel1a',  tamanho:'pequena',  sprite:'aldeia_neutra', dono:null,    par:'santarem',  custoLisboa: 17.0, custoBarcelona:  1.0, desloc:[4.2,10.7] },
  { id:'girona',    nome:'Girona',      x: 1477.5, y:  436.4, lado:'E', papel:'anel1b',  tamanho:'pequena',  sprite:'aldeia_neutra', dono:null,    par:'evora',     custoLisboa: 19.5, custoBarcelona:  1.5, desloc:[-0.9,12.2] },
  { id:'castellon', nome:'Castellon',   x: 1209.0, y:  559.0, lado:'E', papel:'anel2a',  tamanho:'pequena',  sprite:'aldeia_neutra', dono:null,    par:'coimbra',   custoLisboa: 16.5, custoBarcelona:  2.5, desloc:[2.0,11.3] },
  { id:'valencia',  nome:'Valencia',    x: 1152.1, y:  658.4, lado:'E', papel:'anel3a',  tamanho:'grande',   sprite:'aldeia_neutra', dono:null,    par:'porto',     custoLisboa: 16.5, custoBarcelona:  3.5, desloc:[2.7,4.0] },
  { id:'zaragoza',  nome:'Zaragoza',    x: 1092.2, y:  449.6, lado:'E', papel:'anel2b',  tamanho:'media',    sprite:'aldeia_neutra', dono:null,    par:'badajoz',   custoLisboa: 14.0, custoBarcelona:  4.0, desloc:[1.7,14.2] },
  { id:'huesca',    nome:'Huesca',      x: 1178.1, y:  395.2, lado:'E', papel:'anel2c',  tamanho:'pequena',  sprite:'aldeia_neutra', dono:null,    par:'faro',      custoLisboa: 16.0, custoBarcelona:  5.0, desloc:[1.7,10.0] },
  { id:'murcia',    nome:'Murcia',      x: 1050.2, y:  783.6, lado:'E', papel:'anel4a',  tamanho:'pequena',  sprite:'aldeia_neutra', dono:null,    par:'vigo',      custoLisboa: 15.0, custoBarcelona:  5.0, desloc:[1.3,8.0] },
  { id:'teruel',    nome:'Teruel',      x: 1030.5, y:  557.1, lado:'E', papel:'anel3c',  tamanho:'media',    sprite:'aldeia_neutra', dono:null,    par:'salamanca', custoLisboa: 12.5, custoBarcelona:  6.5, desloc:[3.3,11.7] },
  { id:'pamplona',  nome:'Pamplona',    x:  993.1, y:  324.4, lado:'E', papel:'anel3b',  tamanho:'pequena',  sprite:'aldeia_neutra', dono:null,    par:'sevilha',   custoLisboa: 14.5, custoBarcelona:  7.0, desloc:[7.3,13.3] },
  { id:'burgos',    nome:'Burgos',      x:  745.8, y:  347.5, lado:'E', papel:'anel4b',  tamanho:'media',    sprite:'aldeia_neutra', dono:null,    par:'cordoba',   custoLisboa: 12.0, custoBarcelona:  8.0, desloc:[4.7,8.7] },
  { id:'madrid',    nome:'Madrid',      x:  858.9, y:  530.3, lado:'E', papel:'centro',  tamanho:'grande',   sprite:'aldeia_neutra', dono:null,    par:'toledo',    custoLisboa:  9.5, custoBarcelona:  8.5, desloc:[2.7,11.3] },
];
...
const ESTRADAS = [
  { de:'lisboa',    para:'santarem',  custo:  1.0, terreno:'costa'    , via:[[352.9,646.0]] },
  { de:'barcelona', para:'tarragona', custo:  1.0, terreno:'costa'     },
  { de:'evora',     para:'lisboa',    custo:  1.5, terreno:'planicie' , via:[[362.9,677.4]] },
