...
const CIDADES = [
  ...
  { id:'porto',      nome:'Porto',       x:   471.7, y:   395.8, lado:'O', papel:'anel3a', tamanho:'grande',   sprite:'aldeia_neutra', dono:null,   par:'valencia',  custoLisboa:  5.0, custoBarcelona: 13.0, desloc:[0,10] },
  ...
  { id:'vigo',       nome:'Vigo',        x:   511.8, y:   290.7, lado:'O', papel:'anel4a', tamanho:'pequena',  sprite:'aldeia_neutra', dono:null,   par:'murcia',    custoLisboa:  7.5, custoBarcelona: 13.5, desloc:[2,8] },
  { id:'sevilha',    nome:'Sevilha',     x:   601.5, y:   773.0, lado:'O', papel:'anel3b', tamanho:'pequena',  sprite:'aldeia_neutra', dono:null,   par:'pamplona',  custoLisboa:  8.0, custoBarcelona: 12.0, desloc:[0.8,10.9] },
  { id:'cordoba',    nome:'Cordoba',     x:   820.3, y:   877.5, lado:'O', papel:'anel4b', tamanho:'media',    sprite:'aldeia_neutra', dono:null,   par:'burgos',    custoLisboa:  9.5, custoBarcelona:  9.0, desloc:[-0.7,16] },
  { id:'burgos',     nome:'Burgos',      x:   777.9, y:   324.3, lado:'E', papel:'anel4b', tamanho:'media',    sprite:'aldeia_neutra', dono:null,   par:'cordoba',   custoLisboa:  9.0, custoBarcelona:  9.5, desloc:[4.7,8.7] },
  ...
  { id:'pamplona',   nome:'Pamplona',    x:   930.4, y:   301.3, lado:'E', papel:'anel3b', tamanho:'pequena',  sprite:'aldeia_neutra', dono:null,   par:'sevilha',   custoLisboa: 12.0, custoBarcelona:  8.0, desloc:[7.3,13.3] },
  ...
  { id:'valencia',   nome:'Valencia',    x:  1121.1, y:   704.8, lado:'E', papel:'anel3a', tamanho:'grande',   sprite:'aldeia_neutra', dono:null,   par:'porto',     custoLisboa: 13.0, custoBarcelona:  5.0, desloc:[2.7,4] },
  ...
  { id:'murcia',     nome:'Murcia',      x:  1013.7, y:   817.8, lado:'E', papel:'anel4a', tamanho:'pequena',  sprite:'aldeia_neutra', dono:null,   par:'vigo',      custoLisboa: 13.5, custoBarcelona:  7.5, desloc:[1.3,8] },
...
const ESTRADAS = [
  ...
  { de:'castellon',  para:'valencia',   custo:  1.5, terreno:'vale'      , via:[[1124.8,628.2]] },
  { de:'coimbra',    para:'porto',      custo:  1.5, terreno:'vale'      , via:[[517.6,452.4]] },
  ...
  { de:'madrid',     para:'zaragoza',   custo:  2.5, terreno:'planalto'  , via:[[963.0,472.8]] },
  ...
  { de:'madrid',     para:'toledo',     custo:  3.0, terreno:'planicie'  , via:[[797.4,580.0]] },
  { de:'porto',      para:'salamanca',  custo:  3.0, terreno:'planicie'  , via:[[577.2,424.2]] },
  { de:'teruel',     para:'valencia',   custo:  3.0, terreno:'planicie'  , via:[[1031.3,671.1]] },
  ...
  { de:'burgos',     para:'porto',      custo:  4.0, terreno:'planicie'  , via:[[620.7,342.7]] },
  { de:'cordoba',    para:'valencia',   custo:  4.0, terreno:'costa'     , via:[[977.1,802.4]] },
  { de:'burgos',     para:'vigo',       custo:  4.0, terreno:'serra'     , via:[[646.2,296.9]] },
  { de:'cordoba',    para:'murcia',     custo:  4.0, terreno:'costa'     , via:[[918.9,853.7]] },
];
