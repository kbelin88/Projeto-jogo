...
| `dots-studio/dots-3-note-preview:free` | 512k | 461k | opc. | 2 | 2 | ? | ? | 89-91 s em partida | 18 e 19 turnos validos; ~45% das respostas vazias, sem matar a partida | 22/09, seeds 7 e 3 contra o ling-3.0-flash-fin: venceu as DUAS por dominio (75%/2t), 19x2 no T18 e 19x5 no T19. Joga a serio: 52 e 72 envios, 198 e 342 tropas, e esteve com exercito na estrada em 18 de 18 e 19 de 19 turnos. E o primeiro modelo :free a converter dominio duas vezes. Tem quase metade das respostas vazias e ganha na mesma -- o que diz que a metrica que separa modelos aqui nao e validade, e AGENCIA. Candidato a regua nova. |
| `inclusionai/ling-3.0-flash-fin:free` | 262k | 33k | opc. | 2 | 0 | ? | ? | 23-78 s na sonda; em partida acompanha o adversario | 18 e 19 turnos validos, com ordens | 22/09, seeds 7 e 3: perdeu as duas por dominio. O formato nao e o problema -- responde e as ordens sao validas. O problema e AGENCIA: 12 e 15 envios (contra 52 e 72 do adversario), e passou DOIS TERCOS da partida sem um unico exercito na estrada (exercitos-turno: 13 e 15, contra 59 e 85). E por causa disto que as duas partidas deram ZERO combates de estrada: nao e desencontro, e um lado que nao sai. Entesouramento classico, agora com numero que se segue. |
