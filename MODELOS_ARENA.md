...
| `dots-studio/dots-3-note-preview:free` | 512k | 461k | opc. | 12 | 4 confirmadas por dominancia (R1 e R2 de 28/08 como Rei A; seeds 7 e 3 de 22/09 como Rei A) | ? | ? | 95-204 s em partida em 28/08; 89-91 s em 22/09 (a sonda de 1 turno dava 35 s) | ok em 28/08 (1 resposta cortada em 52); em 22/09 ~45% das respostas vazias, sem matar a partida | Aparece em 10 ficheiros de partida entre 19/08 e 28/08 e em mais 2 em 22/09. E o 2o modelo mais rodado da Arena, atras da regua (lightning). Em 28/08 correu 29 e 23 turnos com ZERO erros de rede. Fornecedor diferente dos Nemotron, o que o torna util quando o pool da Nvidia esta degradado. ⚠️ A sonda de 1 turno subestimou a latencia em 3-6x. 22/09, seeds 7 e 3 contra o ling-3.0-flash-fin: venceu as duas por dominio (19x2 no T18, 19x5 no T19), com 52 e 72 envios e exercito na estrada em todos os turnos. Em 22/09 teve quase metade das respostas vazias e ganhou na mesma -- o que separa modelos aqui e AGENCIA, nao validade. ⚠️ As 4 vitorias foram todas como Rei A: o assento nunca foi trocado com ele. |
| `inclusionai/ling-3.0-flash-fin:free` | 262k | 33k | opc. | 3 | 0 | ? | ? | 193 s em partida em 28/08 (86-234 s); 23-78 s na sonda de 21/09 | 28/08: 6 de 15 turnos com ordem, 47% cortadas por `length`; 22/09: 18 e 19 turnos validos | 28/08: perdeu 4x19 para o 120b em 15 turnos. A resposta crescia turno a turno (11k, 16k, 30k) e a partir do T5 batia no teto de 32000 quase sempre, devolvendo finish length e ZERO ordens -- o teto proprio dele e 32768. 22/09 (com o teto novo auto-ajustavel): perdeu as duas contra o dots por dominio. O formato ja nao e o problema; o problema e AGENCIA -- 12 e 15 envios contra 52 e 72, e dois tercos da partida sem um unico exercito na estrada (exercitos-turno 13 e 15, contra 59 e 85). E a causa medida de as duas partidas darem ZERO combates de estrada. ⚠️ Sempre como Rei B. |
