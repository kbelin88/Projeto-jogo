...
(function (root, factory) {
  ...
  const CONFIG = {
    ...
    tropas: {
      ...
      // Fase 7.2 (04/08): REVERTIDA a Fase 4 (20/20 -> 30/30). A baixa de preco
      // sozinha nao atraiu cavalaria (0 construidos): com forca achatada o
      // problema era a ESCADA de unidades, nao o custo. A 7.3 (combate v3) ataca
      // isso dando atq/def distintos.
